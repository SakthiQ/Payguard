-- PayGuard Flyway Migration V1 — Schema Definition
...
CREATE TABLE transactions (
    ...
    type VARCHAR(30) NOT NULL DEFAULT 'TRANSFER', -- TRANSFER, DEPOSIT
    status VARCHAR(30) NOT NULL DEFAULT 'CREATED', -- CREATED, VALIDATING, FLAGGED, COMPLETED, DECLINED, FAILED
...
INSERT INTO fraud_rules (rule_code, rule_name, description, threshold_value, time_window_seconds, enabled)
VALUES 
('HIGH_AMOUNT', 'High Amount Threshold Rule', 'Flags transfers exceeding the high amount limit', 5000.0000, NULL, TRUE),
('HIGH_VELOCITY', 'Transfer Velocity Limit Rule', 'Flags accounts making excessive transfers in a short window', 3.0000, 300, TRUE);